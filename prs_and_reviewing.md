...
The repository we will be opening pull requests to is at https://github.com/scipy-conference/scipy2026_sprints_first_PR .
...
This will create a copy of the repository at ``https://github.com/<username>/scipy2026_sprints_first_PR``
...
You can use HTTPS:
    ...
    git clone -o <username> https://github.com/<username>/scipy2026_sprints_first_PR
...
With ssh set up, you can use:
    ...
    git clone -o <username> git@github.com:<username>/scipy2026_sprints_first_PR
...
#bof-scipy-2026-sprint-prep-bof, to claim a directory to let others know to work in another one to avoid conflicts.
...
of relying on the git defaults of "origin" and "upstream".
    ...
    git remote add scipy-conference https://github.com/scipy-conference/scipy2026_sprints_first_PR
...
rootdir: /Users/bsipocz/munka/devel/scipy2026/scipy2026_sprints_first_PR/participants/scipy_000
...
At this point, go to your fork on GitHub at ``https://github.com/<username>/scipy2026_sprints_first_PR``, and
...
### License
Developed for Scipy 2023--2026 by Brigitta Sipőcz &copy; licensed under a
